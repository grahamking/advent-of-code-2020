...
fn main() {
    println!("Part 1: {}", part1(&[14, 8, 16, 0, 1, 17], 2020));
    println!("Part 2: {}", part1(&[14, 8, 16, 0, 1, 17], 30000000));
}
...
mod tests {
    ...
    #[test]
    fn test_part1() {
        assert_eq!(part1(&[0, 3, 6], 4), 0);
        assert_eq!(part1(&[0, 3, 6], 5), 3);
        assert_eq!(part1(&[0, 3, 6], 6), 3);
